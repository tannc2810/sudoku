        ...
        <div className="w-full aspect-square relative rounded-2xl bg-white border-3 border-slate-300 shadow-xl p-0 overflow-hidden">
          {showStartScreen ? (
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-slate-50/95 backdrop-blur-sm text-center p-4 sm:p-5 animate-fade-in w-full h-full select-none overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-2 w-full max-w-[280px] sm:max-w-xs mb-3 sm:mb-4 shrink-0">
                {(['easy', 'medium', 'hard', 'expert'] as Difficulty[]).map((diff) => (
                   <button
                    key={diff}
                    id={`setup-diff-${diff}`}
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-slate-50/95 backdrop-blur-md text-center p-4 sm:p-5 animate-fade-in w-full h-full select-none overflow-hidden">
              ...
              <div className="flex flex-col gap-1.5 w-full max-w-[240px] shrink-0">
                <button
                  id="win-restart-btn"
                  onClick={() => {
                    startNewGame(difficulty);
                  }}
                  className="w-full py-1.5 sm:py-2 bg-indigo-600 hover:bg-indigo-500 transition rounded-xl font-bold text-[10px] sm:text-xs text-white flex items-center justify-center gap-1"
                >
                  <Play className="w-3.5 h-3.5" /> Tiếp tục chơi cùng cấp độ
                </button>
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-slate-50/95 backdrop-blur-md text-center p-4 sm:p-5 animate-fade-in w-full h-full select-none overflow-hidden">
              ...
              <div className="flex flex-col gap-2 w-full max-w-[225px] shrink-0">
                <button
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-slate-50/95 backdrop-blur-md text-center p-4 sm:p-5 animate-fade-in w-full h-full select-none overflow-hidden">
              ...
              <div className="flex flex-col gap-1.5 w-full max-w-[220px] shrink-0">
                <button
